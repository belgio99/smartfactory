...
def retrieve_keys(microservice_id: str):
    ...
    if connection is None or cursor is None:
        ...
        return json.load(open(API_KEYS_FILE_PATH, 'r'))['microservice'][microservice_id]    
    try:
