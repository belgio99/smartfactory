...
async def get_kpi_endpoint(kpi_id: str, api_key: str = Depends(get_verify_api_key(["kpi-engine"]))):
    """
...
async def get_all_kpis_endpoint(api_key: str = Depends(get_verify_api_key(["api-layer", "ai-agent"]))):
    """
...
async def get_all_machines_endpoint(api_key: str = Depends(get_verify_api_key(["gui"]))):
    """
...
async def is_pair_machine_kpi_exist_endpoint(machine_id: str, kpi_id: str, api_key: str = Depends(get_verify_api_key(["data"]))):
    """
