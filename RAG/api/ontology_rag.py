...
from graph_qa import GraphSparqlQAChain
...
general_QA_chain = GraphSparqlQAChain.from_llm(
    llm, graph=graph, verbose=True, allow_dangerous_requests=True, sparql_select_prompt=general_QA_prompt_select
)
...
kpi_generation_chain = GraphSparqlQAChain.from_llm(
    llm, graph=graph, verbose=True, allow_dangerous_requests=True, sparql_select_prompt=kpi_generation_prompt_select, qa_prompt=qa_kpi_generation_prompt
)
...
dashboard_generation_chain = GraphSparqlQAChain.from_llm(
    llm, graph=graph, verbose=True, allow_dangerous_requests=True, sparql_select_prompt=dashboard_generation_prompt_select, qa_prompt=qa_dashboard_generation_prompt
)
